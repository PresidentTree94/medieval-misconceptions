...
export default function HomePage({ categories, topics, figures }: {
  ...
  const stats = [
    { label: "Categories", number: categories.length },
    { label: "Topics", number: topics.length },
    { label: "Figures", number: figures.length }
  ];
    ...
    <main>
      ...
      <section>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-0">
          ...
          <div className="bg-gradient-to-br from-[oklch(91%_0.04_25)]/70 via-[oklch(96%_0.02_25)]/50 to-[oklch(93%_0.06_87)]/60 flex items-center justify-center rounded-xl overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
            <div className="bg-background-light rounded-xl border border-[oklch(95%_0.018_82)] overflow-hidden">
              <div className="relative aspect-video">
                <Image src="https://placehold.co/400x256/png" alt="article" fill className="w-full h-full object-cover" />
              </div>
              <div className="p-5">
                <span className="uppercase text-xs font-semibold tracking-wide bg-[oklch(93%_0.06_87)] px-2.5 py-1 rounded-full mb-2.5 inline-block text-subtext">Category</span>
                <h3 className="font-semibold md:text-lg">Article Title Goes Here</h3>
      ...
      <Section
        ...
        type="figures"
        number={figures.length}>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-10">
          {figures.slice(0, 4).map((f, index) => (
